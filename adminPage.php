...
<?php include 'adminNavigation.php'; ?>
  ...
  <?php
    ...
    $query = " SELECT `path`, `title`, `amount`, `navpath`, `id` FROM `seemore` order by id ASC ";
        ...
        <div class="col-lg-3 col-md-3 col-12 pb-5" >
          ...
          <div class="card">
            ...
            <div class="btn-group d-flex">
              <button class="btn btn-primary flex-fill" type="submit">Update</button>
              <button class="btn btn-success flex-fill" type="submit" formaction="delete.php">Delete</button>
            </div>
          </div>
          </form>
        </div>
...
<div class="mb-5" style="text-align: center;font-size: 20px;">
    <a href="insertAdmin.php" style="color: white;"><b>Insert</b></a>
  </div>
</div>
</section>
