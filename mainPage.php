...
<section class="mt-5">
  ...
  <?php
    ...
    $query = " SELECT `path`, `title`, `amount`, `navpath`, `id` FROM `seemore` where id<10 order by id ASC ";

    //$query = " SELECT `path`, `title`, `amount`, `navpath`, `id` FROM `seemore` order by id DESC LIMIT 8 ";
    ...
    if ($num > 0) {
       while ($product = mysqli_fetch_array($queryfire)) {
        ...
        <div class="col-lg-3 col-md-3 col-12 pb-5" >
          <form method="post" action="buyLater.php">
          <div class="card">
            <div class="inner">
            ...
            <div class="card-body">
              ...
              <label class="card-text" > &#8377; <?php echo $product['amount']; ?></label>
...
<div class="mb-5" style="text-align: center;font-size: 20px;">
    <a href="seeMore.php" style="color: white;"><b>See More >></b></a>
  </div>
